# Lesson20
Lesson20 OpenGL (from NeHe)

Vous trouverez dans le sommaire ci-dessous les explications vous permettant de régénérer cette application illustrant un nouveau
cas d'usage d'OpenGL : le "masking"* (issu du site neHe).
...
Voici un résumé succinct concernant ce nouveau tutorial :

## OpenGL Tutorial #20.

Project Name: Jeff Molofee's OpenGL Tutorial

Project Description : Masking Tutorial
